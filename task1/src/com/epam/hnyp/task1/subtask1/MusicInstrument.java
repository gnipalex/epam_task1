...
public class MusicInstrument {
	 ...
	 * @param vendor
	 * @param year
	 * @throws IllegalArgumentException if vendor is not specified or year isn't in 1900...nowadays
	 */
	public MusicInstrument(String vendor, int year) {
		...
		if (year < 1900 && year > Calendar.getInstance().get(Calendar.YEAR)) {
			throw new IllegalArgumentException("year must be in 1900...nowadays");
		}
		this.vendor = vendor;
		this.year = year;
	}
	...
	public String toString() {
		...
		str.append("music instrument : vendor ").append(vendor).append(", year ").append(year);
		return str.toString();
	}
