<%@ tag language="java" body-content="empty" description="Adds 'buy' button to product"%>
...
<button class="${cssClass}" title="add to cart" onclick="addToCartInHeader(${productId});"></button>